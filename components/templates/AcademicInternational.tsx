...
export const AcademicInternational: React.FC<TemplateProps> = ({ data, paperSize = "letter" }) => {
  ...
  return (
    ...
    >
      ...
      <header className="text-center pb-1.5 mb-2">
        <h1 className="text-[17pt] font-bold text-zinc-950 uppercase tracking-tight mb-0.5">
        ...
        {contactItems.length > 0 && (
          <div className="text-[8.5pt] text-zinc-700 flex flex-wrap justify-center items-center gap-x-2.5 gap-y-0.5">
            ...
            case "education":
              ...
              return (
                <section key="education" className="page-break-avoid">
                  <h2 className="text-[10pt] font-bold uppercase tracking-wider text-zinc-950 border-b border-zinc-400 pb-0.5 mb-1.5">
                    {labels.education}
                  </h2>
                    ...
                    {education.map((edu) => (
                      <div key={edu.id} className="page-break-avoid">
                        ...
                        {edu.highlights && edu.highlights.length > 0 && (
                          <ul className="list-disc list-outside ml-4 mt-0.5 space-y-0.5 text-[8.5pt] text-zinc-700 leading-snug">
                        ...
                        <div className="flex justify-between items-baseline mb-0.5">
                          <div>
                            ...
                            {proj.technologies && proj.technologies.length > 0 && (
                              <span className="text-[8.5pt] text-zinc-600 ml-1.5 font-medium">
                                | {proj.technologies.join(", ")}
                              </span>
                            )}
                          </div>
                          {proj.start_date && (
                            <span className="text-[8pt] text-zinc-600 shrink-0 font-medium">
                              {proj.start_date}
            ...
            case "skills":
              ...
              return (
                <section key="skills" className="page-break-avoid">
                  <h2 className="text-[10pt] font-bold uppercase tracking-wider text-zinc-950 border-b border-zinc-400 pb-0.5 mb-1">
                    {labels.skills}
                  </h2>
                  <div className="space-y-0.5 text-[9pt]">
                    {skills.map((cat) => (
                      <div key={cat.id || cat.category} className="leading-snug">
                        <span className="font-bold text-zinc-900 text-[8.5pt] mr-1">
                          {cat.category}:{" "}
                        </span>
